...
def test_classifier(clf, dataset, feature_list, folds = 1000,return_precision=False,return_F1=False,return_recall=False):
    """
    Tests the performance of a classifier.
    Returns precision, f1 or recall if a corresponding parameter is True.
    If none of these are true then prints out an evaluation report.
    """
